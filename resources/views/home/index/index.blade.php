    ...
    <div class="layui-row">
        <div class="layui-card">
            <div class="layui-card-body">
                <p>
                    卡片式面板面板通常用于非白色背景色的主体内 卡片式面板面板通常用于非白色背景色的主体内 卡片式面板面板通常用于非白色背景色的主体内 卡片式面板面板通常用于非白色背景色的主体内
                ...
                <div class="demoTable">
                    ...
                    <div class="layui-inline layui-col-xs3">
                        <select name="city" lay-verify="" lay-search id="demoReload1">
                            ...
                            @foreach($game_name as $v)
                                <option value="{{ $v->game_name }}">{{ $v->game_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="layui-inline layui-col-xs3">
                    ...
                    <div class="layui-inline layui-col-xs3">
                        <select name="city" lay-verify="" lay-search id="demoReload8">
                            ...
                            @foreach($game_stage as $v)
                                <option value="{{ $v->game_stage }}">{{ $v->game_stage }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="layui-inline layui-col-xs3">
                        <select name="city" lay-verify="" lay-search id="demoReload9">
                            ...
                            @foreach($game_project as $v)
                                <option value="{{ $v->game_project }}">{{ $v->game_project }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="layui-inline">
            ...
            <div class="demoTable1">
                <div class="layui-inline layui-col-xs3">
                    <select name="city" lay-verify="" lay-search id="sou_one" class="layui-input layui_select">
                        ...
                        @foreach($user as $v)
                            <option value="{{ $v->id }}" class="option_item">{{ $v->user_name }}</option>
                        @endforeach
                    </select>
                </div>
...
<script src="/home/js/laydate.js"></script>
                ...
                table.reload('testReload', {
                    ...
                    , where: {
                        key: {
                            ...
                            'user_a': demoReload3.val(),
                            'user_b': demoReload4.val(),
...
<script>
    layui.use('table', function () {
        ...
        table.on('tool(user)', function (obj) {
            ...
            // console.log(data.id);
            if (obj.event === 'detail') {
                location.href = '{{ route('home_list') }}' + '?id=' + data.id
