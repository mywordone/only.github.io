...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		<a href="javascript:;" onclick="matchdata_import('导入数据','','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe642;</i> 导入比赛数据</a>
	</span> <span class="r">共有数据：<strong>XX</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<tr class="text-c">
				...
				<td></td>
				<td>
					<a title="选项查看" href="javascript:;" onclick="show('')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe695;</i>选项查看</a>
				</td>
				<td></td>
				<td></td>
				<td class="td-manage">
